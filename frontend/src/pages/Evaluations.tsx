...
export default function EvaluationsPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      toast(error instanceof Error ? error.message : 'Failed to load evaluation data', 'error')
    } finally {
      setLoading(false)
    }
  }, [apiFilters, toast])
